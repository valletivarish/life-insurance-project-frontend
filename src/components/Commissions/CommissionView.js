...
import { downloadCommissionReport, getAllCommissions, getCommissionTypes } from "../../services/gaurdianLifeAssuranceServices";
...
const CommissionView = () => {
  ...
  const fetchCommissions = async (params) => {
    try {
      ...
      const sanitizeData=sanitizeCommissionData(response,  ["commissionId",
        "commissionType",
        "issueDate",
        "amount",
        "agentId",
